    ...
    if(TARGET spdlog::spdlog)
        ...
        if(spdlog_FOUND)
            ...
            if(SPDLOG_INCLUDE_DIR)
                ...
                target_include_directories(wifibroadcast PRIVATE ${SPDLOG_INCLUDE_DIR})
                target_compile_definitions(wifibroadcast PRIVATE SPDLOG_HEADER_ONLY)
            elseif(TARGET OHDCommonLib)
                ...
                if(WB_FETCH_SPDLOG)
                    ...
                    if(TARGET spdlog::spdlog_header_only)
                        target_link_libraries(wifibroadcast PRIVATE spdlog::spdlog_header_only)
                    else()
                        target_link_libraries(wifibroadcast PRIVATE spdlog::spdlog)
                    endif()
                else()
